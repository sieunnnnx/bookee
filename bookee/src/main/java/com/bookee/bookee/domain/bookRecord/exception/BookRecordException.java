...
public enum BookRecordException implements BaseCode {
    ...
    BOOK_RECORD_NOT_FOUND("BOOK-RECORD-01", "해당 독서록 기록을 찾을 수 없습니다."),
    ...
    NO_PERMISSION("BOOK-RECORD-06", "자신이 작성한 독서 기록만 삭제할 수 있습니다."),
    QUOTE_NOT_FOUND("BOOK-RECORD-01", "해당 글귀를 찾을 수 없습니다.");
